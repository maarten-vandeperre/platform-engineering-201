...
import com.redhat.workshop.people.notification.DeveloperHubNotificationService;
...
public class PersonResource {
    ...
    @Inject
    DeveloperHubNotificationService developerHubNotificationService;
    ...
    public Response create(PersonRequest request) {
        ...
        person.persist();
        PersonResponse created = PersonResponse.from(person);
        developerHubNotificationService.notifyPersonCreated(created);
    ...
    public PersonResponse update(@PathParam("id") Long id, PersonRequest request) {
        ...
        person.lastName = request.lastName().trim();
        person.age = request.age();
        PersonResponse updated = PersonResponse.from(person);
        developerHubNotificationService.notifyPersonUpdated(updated);
        return updated;
    }
    ...
    public Response delete(@PathParam("id") Long id) {
        Person person = findPerson(id);
        PersonResponse deleted = PersonResponse.from(person);
        person.delete();
        developerHubNotificationService.notifyPersonDeleted(deleted);
